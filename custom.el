(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-pro vcl-mode solidity-mode highlight-indentation dockerfile-mode markdown-mode lsp-mode highlight-parentheses which-key yaml-mode json-mode dap-mode lsp-java lsp-ui company-lsp hydra helm-projectile projectile helm-ag helm doom-modeline all-the-icons ztree multiple-cursors ace-window magit yasnippet symbol-overlay flycheck company expand-region))
