(custom-set-variables
 ...
 '(package-selected-packages
   '(eglot transient edit-indirect nginx-mode polymode groovy-mode git-timemachine jinja2-mode flymake-collection docker yaml-pro vundo doom-themes cape corfu wgrep vertico orderless embark-consult marginalia markdown-mode doom-modeline ztree multiple-cursors ace-window magit yasnippet symbol-overlay expand-region))
...
(custom-set-faces
 ...
 '(symbol-overlay-face-6 ((t (:background "dark salmon" :foreground "#282c34"))))
 '(symbol-overlay-face-7 ((t (:background "plum3" :foreground "#282c34"))))
 '(symbol-overlay-face-8 ((t (:background "IndianRed1" :foreground "#282c34")))))
