...
(custom-set-faces
 ...
 '(symbol-overlay-face-2 ((t (:background "unspecified" :underline "green1"))))
 '(symbol-overlay-face-3 ((t (:background "unspecified" :underline "yellow1"))))
 '(symbol-overlay-face-4 ((t (:background "unspecified" :underline "DeepSkyBlue1"))))
 ...
 '(symbol-overlay-face-7 ((t (:background "unspecified" :underline "sandy brown"))))
